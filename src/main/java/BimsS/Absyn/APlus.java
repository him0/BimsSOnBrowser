...
public class APlus extends AExp {
  public final AExp aexp_1, aexp_2;
  public APlus(AExp p1, AExp p2) { aexp_1 = p1; aexp_2 = p2; }

  public <R,A> R accept(BimsS.Absyn.AExp.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof BimsS.Absyn.APlus) {
      BimsS.Absyn.APlus x = (BimsS.Absyn.APlus)o;
