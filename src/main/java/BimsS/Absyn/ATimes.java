...
public class ATimes extends AExp {
  public final AExp aexp_1, aexp_2;
  public ATimes(AExp p1, AExp p2) { aexp_1 = p1; aexp_2 = p2; }

  public <R,A> R accept(BimsS.Absyn.AExp.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof BimsS.Absyn.ATimes) {
      BimsS.Absyn.ATimes x = (BimsS.Absyn.ATimes)o;
