...
public class AMinus extends AExp {
  public final AExp aexp_1, aexp_2;
  public AMinus(AExp p1, AExp p2) { aexp_1 = p1; aexp_2 = p2; }

  public <R,A> R accept(BimsS.Absyn.AExp.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof BimsS.Absyn.AMinus) {
      BimsS.Absyn.AMinus x = (BimsS.Absyn.AMinus)o;
